...
### Option A: One-Line Resume Summary
- **Striver DSA AI Mentor**: Architected a full-stack RAG system over **316 Striver DSA lectures** (**7,601 Qdrant vectors**, 14.5MB BM25 index) featuring **Faster-Whisper CUDA transcription**, **RRF Hybrid Search**, **Cross-Encoder Reranking**, and **FastAPI / Express / React**.

---

### Option B: Two-Bullet Resume Summary
- **Engineered a 3-Stage Hybrid RAG Engine** indexing **316 Striver A2Z DSA YouTube lectures** (**7,601 Qdrant Cloud vectors**) by combining **384-dim dense embeddings** (`all-MiniLM-L6-v2`) and **BM25 keyword search** via **Reciprocal Rank Fusion (RRF, k=60)** and **Cross-Encoder (`ms-marco-MiniLM-L-6-v2`) reranking**.
- **Built a Production 3-Tier Web Application** featuring **Faster-Whisper CUDA transcription** with automated CPU fallback, **75s time-aware transcript chunking** for timestamp-precise YouTube citations, and 5 interactive tutor modes across **FastAPI, Express, and React 18**.

---

### Option C: Detailed Role-Tailored Bullet Points

#### 1. AI / ML Engineer Focus (RAG, Search Architecture, & LLMs)
...
#### 2. Full-Stack / Backend Engineer Focus (System Design, APIs, & Pipeline Resilience)
